...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <input type="text" class="form-control" name="cliente" placeholder="ingrese el nombre del cliente">
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="date" class="form-control" name="pres" placeholder="ingrese la fecha del prestamo">
          </div>

          <div class="mb-3">
            <label  class="form-label">FECHA DE DEVOLUCION</label>
            <input type="date" class="form-control" name="dev" placeholder="ingrese la fecha de la devolucion">
          </div>
