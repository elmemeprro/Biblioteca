    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" name="telefono" placeholder="ingrese el numero de telefono del cliente">
          </div>

          <div class="mb-3">
            <label  class="form-label">CORREO</label>
            <input type="email" class="form-control" name="correo" placeholder="ingrese el correo del cliente">
          </div>
